...
describe('Request', () => {
  ...
  describe('GET /accepted-answer/:soID', () => {
    it('returns the accepted answer', () => {
      return get('/accepted-answer/2067472', STATUS_OK).then(post =>
        expectPost(2067584, post)
      );
    });
  ...
  describe('GET /npm-answers', () => {
    xit('returns answers to npm questions', () => {
      ...
      return get('/npm-answers', STATUS_OK).then(posts =>
        expectPosts(expectedPostIDs, posts)
      );
    });
  });
});
